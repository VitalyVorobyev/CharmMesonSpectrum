...
MEAS = [
    meas_item(*args) for args in [
        ...
        ['AUBERT 09AB'      , 0, False, r'$D^+\pi^-$',     r'$0^+$', mval(2297,   8,  20),    mval(273, 12, 48),       r'$B^-\to D^+\pi^-\pi^+$'       ,  3.4e3, 'M178', True],  # M179
        ...
        ['DEL-AMO-SA... 10P', 0,  True, r'$D^{*+}\pi^-$',      'un', mval(2420.1, 0.1, 0.8),  mval(31.4, 0.5, 1.3),    r'$e^+e^-\to D^{*+}\pi^-X$'     ,  103e3, 'M097', True],
...
NOTES = [
    """ ABE 04D: signal yield for the B^+\to D^{*+}\pi^-\pi^+ mode is 560 """
