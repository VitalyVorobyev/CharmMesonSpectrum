...
lfv_dn = {
    ...
    [
        ...
        [2.8,   'BESIII', 'Phys. Rev. D99 (2019) 112002', 2.93],
...
lfv_dp = {
    ...
    r'$K^-\mu^+\mu^+$':
    [
        [320.0, 'E653', 'Phys. Lett. B345 (1995) 85'],
        [120.0, 'E687', 'Phys. Lett. B398 (1997) 239'],
        [13.0, 'Focus', 'Phys. Lett. B572 (2003) 21'],
        [10.0, 'BaBar', 'Phys. Rev. D84 (2011) 072006'],
    ],
    r'$K^-e^+\mu^+$':
    [
        [130.0, 'E687', 'Phys. Lett. B398 (1997) 239'],
    ...
    r'$K^-\pi^0e^+e^+$':
    [
        [8.5, 'BESIII', 'Phys. Rev. D99 (2019) 112002', 2.93],
    ],
    r'$K_S^0\pi^-e^+e^+$':
    [
        [3.3, 'BESIII', 'Phys. Rev. D99 (2019) 112002', 2.93],
    ],
    r'$K^{*-}(892)\mu^+\mu^+$':
    [
        [850.0, 'E653', 'Phys. Lett. B345 (1995) 85'],
    ],
}
...
rare_ds = {
    r'$\gamma e^+\nu_e$':
    [
        [130.0, 'BESIII', 'Phys. Rev. D99 (2019) 072002', 3.19],
    ],
    r'$\pi^+e^+e^-$':
    [
        [270.0, 'E791',  'Phys. Lett. B462 (1999) 401'],
        [22.0,  'CLEOc', 'Phys. Rev. D82 (2010) 092007', 1.42],
        [13.0,  'BaBar', 'Phys. Rev. D84 (2011) 072006'],
        [5.5,   'LHCb',  'JHEP 06 (2021) 044'],
    ],
    r'$\pi^+\mu^+\mu^-$':
    [
        [430.0, 'E653',  'Phys. Lett. B345 (1995) 85'],
        [140.0, 'E791',  'Phys. Lett. B462 (1999) 401'],
        [43.0,  'BaBar', 'Phys. Rev. D84 (2011) 072006'],
        [26.0,  'Focus', 'Phys. Lett. B572 (2003) 21'],
        [0.18,  'LHCb',  'JHEP 06 (2021) 044'],
    ],
    r'$K^+e^+e^-$':
    [
        [1600.0, 'E791',  'Phys. Lett. B462 (1999) 401'],
        [52.0,   'CLEOc', 'Phys. Rev. D82 (2010) 092007', 1.42],
        [4.9,    'LHCb',  'JHEP 06 (2021) 044'],
        [3.7,    'BaBar', 'Phys. Rev. D84 (2011) 072006'],
    ],
    r'$K^+\mu^+\mu^-$':
    [
        [140.0, 'E791',  'Phys. Lett. B462 (1999) 401'],
        [36.0,  'Focus', 'Phys. Lett. B572 (2003) 21'],
        [21.0,  'BaBar', 'Phys. Rev. D84 (2011) 072006'],
        [0.14,  'LHCb',  'JHEP 06 (2021) 044'],
    ],
    r'$K^{*+}(892)\mu^+\mu^-$':
    [
        [1400.0, 'E653', 'Phys. Lett. B345 (1995) 85'],
    ],
}
...
lfv_ds = {
    r'$\pi^+e^{\pm}\mu^{\mp}$':
    [
        [610.0, 'E791', 'Phys. Lett. B462 (1999) 401'],
    ],
    r'$\pi^+e^+\mu^-$':
    [
        [12.0, 'BaBar', 'Phys. Rev. D84 (2011) 072006'],
        [1.1,  'LHCb',  'JHEP 06 (2021) 044'],
    ],
    r'$\pi^+\mu^+e^-$':
    [
        [20.0, 'BaBar', 'Phys. Rev. D84 (2011) 072006'],
        [0.94, 'LHCb',  'JHEP 06 (2021) 044'],
    ],
    r'$K^+e^{\pm}\mu^{\mp}$':
    [
        [630.0, 'E791', 'Phys. Lett. B462 (1999) 401'],
    ],
    r'$K^+e^+\mu^-$':
    [
        [14.0, 'BaBar', 'Phys. Rev. D84 (2011) 072006'],
        [0.79, 'LHCb',  'JHEP 06 (2021) 044'],
    ],
    r'$K^+\mu^+e^-$':
    [
        [9.7,  'BaBar', 'Phys. Rev. D84 (2011) 072006'],
        [0.56, 'LHCb',  'JHEP 06 (2021) 044'],
    ],
    r'$\pi^-e^+e^+$':
    [
        [690.0, 'E791',  'Phys. Lett. B462 (1999) 401'],
        [18.0,  'CLEOc', 'Phys. Rev. D82 (2010) 092007', 1.42],
        [4.1,   'BaBar', 'Phys. Rev. D84 (2011) 072006'],
        [1.4,   'LHCb',  'JHEP 06 (2021) 044'],
    ],
    r'$\pi^-\mu^+\mu^+$':
    [
        [430.0, 'E653',  'Phys. Lett. B345 (1995) 85'],
        [82.0,  'E791',  'Phys. Lett. B462 (1999) 401'],
        [29.0,  'Focus', 'Phys. Lett. B572 (2003) 21'],
        [14.0,  'BaBar', 'Phys. Rev. D84 (2011) 072006'],
        [0.086, 'LHCb',  'JHEP 06 (2021) 044'],
    ],
    r'$\pi^-e^+\mu^+$':
    [
        [730.0, 'E791', 'Phys. Lett. B462 (1999) 401'],
        [0.63,  'LHCb', 'JHEP 06 (2021) 044'],
    ],
    r'$K^-e^+e^+$':
    [
        [630.0, 'E791',  'Phys. Lett. B462 (1999) 401'],
        [17.0,  'CLEOc', 'Phys. Rev. D82 (2010) 092007', 1.42],
        [5.2,   'BaBar', 'Phys. Rev. D84 (2011) 072006'],
        [0.77,  'LHCb',  'JHEP 06 (2021) 044'],
    ],
    r'$K^-\mu^+\mu^+$':
    [
        [590.0, 'E653',  'Phys. Lett. B345 (1995) 85'],
        [180.0, 'E791',  'Phys. Lett. B462 (1999) 401'],
        [13.0,  'BaBar', 'Phys. Rev. D84 (2011) 072006'],
        [0.026, 'LHCb',  'JHEP 06 (2021) 044'],
    ],
    r'$K^-e^+\mu^+$':
    [
        [680.0, 'E791', 'Phys. Lett. B462 (1999) 401'],
        [0.26, 'LHCb', 'JHEP 06 (2021) 044'],
    ],
    r'$K^{*-}(892)\mu^+\mu^+$':
    [
        [1400.0, 'E653', 'Phys. Lett. B345 (1995) 85'],
